export default function Entry(){
    return(
      ...
      <div class="text">
       ...
       <p class="summary">The nature containing millions of insects , animals . billions of human beings especially on earth taking care of existence of each species by completing the food chain .</p>
      </div>
     </div>
     <div class="entry">
      <div class="image">
      ...
      <p>The nature containing millions of insects , animals . billions of human beings especially on earth taking care of existence of each species by completing the food chain .</p>
     </div>
     </div>
